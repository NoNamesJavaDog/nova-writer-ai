...
from auth import get_password_hash, generate_uuid
...
if __name__ == "__main__":
    if len(sys.argv) < 3:
        print("用法: python create_user.py <用户名> <密码> [邮箱]")
        print("示例: python create_user.py lanf Gauss_234 lanf@example.com")
        sys.exit(1)
